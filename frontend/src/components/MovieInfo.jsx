...
const MovieInfo = ({movie}) => {
    ...
    return (
        <div className="pt-10 flex flex-col justify-center items-center text-xl font-sans">
            ...
            <p className="flex pt-6 pb-4 font-bold text-xl md:text-2xl">{movie.Title}<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 m-auto" fill="red" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
