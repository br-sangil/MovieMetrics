...
export default function Home() {
    ...
    if (!movie || movie === undefined || movie.length === 0) {
      return (
        <div className="bg-movie-posters">
          <div className="bg-slate-100 w-4/5 h-3/4 drop-shadow-2xl rounded-lg">
        <p className="text-8xl font-sans font-bold">
          Hold on...
        </p>
        <svg xmlns="http://www.w3.org/2000/svg" className="animate-spin h-96 w-96" viewBox="0 0 20 20" fill="red">
